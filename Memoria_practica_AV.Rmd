...
Probamos nuestros datos de validación para el modelo seleccionado, 

```{r}
pred_bag <- predict(modeloBagging2, df_baggin_validation ,type="class")
```
...
cf_bag_val <-confusionMatrix(pred_bag, as.factor(df_baggin_validation$target),positive="1")
cf_bag_val
```
