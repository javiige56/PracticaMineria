...
nadadoresPruebas2 <- nadadoresPruebas %>%
...
Parece que nos va a servir más verlo con porcentajes:
```{r}
# Crear una nueva columna para clasificar por edad
nadadoresPruebas2 <- nadadoresPruebas %>%
  mutate(grupo_edad = ifelse(edad < 18, "Menores de 18", "18 y más"))
...
El punto 5 representa una observación, probablemente correspondiente a un participante más joven, pero con un tiempo de reacción muy alto.  La edad parece tener poca o ninguna influencia negativa en su desempeño.
...
De hecho el 26, parece ser un nadador con unos tiempos de reacción muy altos.

Para ver que hemos concluido bien, represento pero con nombres
```{r}
