...
matrizconfusion1 <- confusionMatrix(predicciones, df$target, positive = "1")
...
Es como lanzar una moneda al aire. No es un buen modelo. Vamos a probar a escalar, meter otras variables, e incluso probar con otras matrices de distancia para intentar mejorarlo. También, Vamos a probar a bajar el número de vecinos próximos entre otras cosas. 
...
### Knn definiendo distancias. 

En este apartado, voy a intentar definir una matriz de similitudes entre observaciones, y, a partir de ahí, tratar de hacer un modelo que no sea tan "caja negra".
