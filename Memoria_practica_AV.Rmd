...
```{r}
datos2015<- datos2015 %>% convert_as_factor(gender,distance,name,code,round,heat,lane,stroke, relaycount)
```
...
Vemos que hay 6 **distancias** y 5 ***tipos de nado***: braza, mariposa, crol, espalda y estilos individual.
...
Nuestro nadador de la primera fila, Ben Treffers, fue descalificado. (luego hago otra observación)
