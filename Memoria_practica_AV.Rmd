...
```{r}
fviz_nbclust(free800WomensNormalizado[,-1], kmeans, method = "silhouette")
```
...
```{r}
fviz_cluster(cluster800libres, data = free800WomensNormalizado[,-1])
```

Bien, ahora para poder sacar las conclusiones debidas, voy a querer graficar la tabla, donde cada nadadora (fila), va a tener asociado un cluster. 
