...
## Curvas ROC esto quitar se supone
...
cf_bag_test
```
El modelo muestra un claro sobreajuste. Si bien funciona perfectamente en el conjunto de entrenamiento, su rendimiento en el conjunto de prueba es malo, lo que sugiere que no puede generalizar bien. Sin embargo, se comporta ligeramente mejor que en el caso anterior.
...
# Imprimir los valores de AUC
#cat("AUC KNN modelo 1", auc_1, "\n")
#cat("AUC KNN modelo 2:", auc_2, "\n")
#cat("AUC KNN modelo 2:", auc_3, "\n")
...
# Graficar las curvas ROC
plot(roc_1, col = "blue", lwd = 2, main = "Comparación de Curvas ROC para los Mejores Modelos", xlim = c(0, 1), ylim = c(0, 1))
...
legend("bottomright", legend = c("Árbol", "Knn", "Random Forest"),
       col = c("blue", "red", "pink"), lwd = 2, cex = 0.5) 
```
Teniendo en cuenta los resultados en cada uno de los modelos ajustados y las curvas ROC, tomamos el modelo Random Forest como el mejor modelo para predecir nuestra variable objetivo. 
