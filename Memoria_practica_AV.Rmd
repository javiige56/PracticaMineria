...
Si visualizamos la tabla datos2015, observamos por cada prueba de cada nadador, salen n filas que equivalen a los n parciales (de 50m ) en los que constaba la prueba, luego, para algunos estudios, usar esta tabla va a suponer duplicar, triplicar e incluso multiplicar por 15 un mismo valor. Además, "ponderaría" más variables como el tiempo de reacción en nadadores de 1500 puesto que se usaría ese valor 15 veces por cada vez que se usa en un nadador de una prueba de 50 metros. 

A continuación procedo a presentar las tablas que vamos a utilizar dependiendo lo que queramos estudiar: 
...
```{r, echo=FALSE}
rm(anova_tiempoReaccion_Calles, lmPuntosCalle, lmPuntosCalle2, colores )
