...
## Estudio sobre la relación entre la edad de los nadadores y las distancias que nadan. ? (javi)
...
# Tareas por hacer e ideas surgidas:
 ...
 - Hacer el clustering.
 - Hacer un pca del 100 braza masculino y clustering (Javi)
 - Hacer un pca del 50 mariposa masculino y clustering(cada uno que haga un PCA) y sacar conclusiones
 -EDA el grafico de paises en vez de por numero de personas, el numero de puntos (Javi) 
