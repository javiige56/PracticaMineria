...
Vamos a hacer knn solo con las variables continuas dado que usamos por defecto distancia euclídea.
...
modelo1knn = knn3(df[,-1], as.factor(df$target), k=5, prob=TRUE)
...
# Falta tratar correctamente la variable hora
