...
Veo ahora sus predicciones de test: 
...
Parece que sobreajusta, voy a ver los datos en test: 
...
Confirmamos que tiende al sobreajuste, en el siguiente modelo, vamos a tratar de definir mejor el control sobre el árbol creado.
