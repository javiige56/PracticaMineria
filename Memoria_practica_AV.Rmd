...
resumen200 <- resumen200 %>% dplyr::select(lastname,points,edad) %>%
    distinct() %>%         
    arrange(desc(points))
...
El punto 5 representa una observación con buen rendimiento en las pruebas de natación de 50, 100, 150, y 200 metros, y probablemente corresponde a un participante más joven. La edad parece tener poca o ninguna influencia negativa en su desempeño.
...
##lo de abajo ya estaba no se q es
