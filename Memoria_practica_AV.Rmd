...
De aquí, podemos observar que tenemos algunos valores nulos (NA's), durante toda la competición, como máximo hubo 12 series y como mínimo 1.
...
Nos puede resultar extraño que haya un nadador de 10 años de edad.
Por tanto, procedemos a contrastar la información.
...
Según observamos la gráfica observamos que la distribución está ligeramente desplazada a la derecha para los hombres, esto indica que los hombres tienden a ser mayores en promedio que las mujeres.
...
Bien, así observamos los nombres. Veamos cómo queda el biplot:
